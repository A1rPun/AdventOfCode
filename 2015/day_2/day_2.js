(function () {
    function day_2(puzzle) {
        ...
        return Promise.resolve([paper, ribbon]);
    }
    December.addDay({
        day: 2,
        year: 2015,
        title: 'I Was Told There Would Be No Math',
        questions: ['How many total square feet of wrapping paper should they order?', 'How many total feet of ribbon should they order?'],
        answer: day_2,       
        example: function () {
            return '2x3x4\nx1x10';
        },
