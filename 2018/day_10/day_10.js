(function () {
    ...
    function day_10(puzzle) {
        ...
        */
        return Promise.resolve(['HJBJXRAZ', answer2]);
    }
    December.addDay({
        day: 10,
        year: 2018,
        title: 'The Stars Align',
        questions: ['What message will eventually appear in the sky?', 'How many seconds would they have needed to wait for that message to appear?'],
        answer: day_10,
        example: function () {
