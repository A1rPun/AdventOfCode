(function () {
    ...
    function day_4(puzzle) {
        puzzle = puzzle.split('\n');
        const duties = puzzle.sort().map(x => x.match(/\d+/g).map(d => parseInt(d, 10)));
    ...
    December.addDay({
        ...
        year: 2018,
        title: 'Repose Record',
        questions: 'What is the ID of the guard you chose multiplied by the minute you chose?',
        answer: day_4,
        example: function () {
