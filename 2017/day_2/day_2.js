(function () {
    ...
    December.addDay({
        ...
        questions: ['What is the checksum for the spreadsheet in your puzzle input?', 'What is the sum of each row\'s result in your puzzle input?'],
        answer: day_2,
        input: function () {
