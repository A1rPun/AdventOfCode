            ...
            switch (tile) {
                case '+':
                    ...
                    if (direction === directions.top || direction === directions.bottom) {
                        ...
                        direction = !rightNeighbor || rightNeighbor === '|' || rightNeighbor === ' ' ? directions.left : directions.right;
                    } else {
                        const bottomNeighbor = grid[y + 1];
                        direction = !bottomNeighbor || bottomNeighbor[x] === '-' || bottomNeighbor[x] === ' ' ? directions.top : directions.bottom;
                    }
                    break;
                case '|':
                case '-':
