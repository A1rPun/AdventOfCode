(function () {
    ...
    function day_11(puzzle) {
        ...
        return Promise.resolve([home.distanceTo(end), furthestDistance]);
    }
    December.addDay({
        day: 11,
        year: 2017,
        title: 'Hex Ed',
        questions: 'You have the path the child process took. Starting where he started, you need to determine the fewest number of steps required to reach him.',
        answer: day_11,
        example: function () {
