(function () {
    ...
    class Particle {
        ...
        distance(v) {
            return Math.abs(this.position.x - v.position.x) + Math.abs(this.position.y - v.position.y) + Math.abs(this.position.z - v.position.z);
        }
    }
    ...
    December.addDay({
        ...
        questions: 'Which particle will stay closest to position <0,0,0> in the long term?',
        answer: day_20,
        example: function () {
