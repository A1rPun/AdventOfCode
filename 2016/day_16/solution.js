...
function day_16(puzzle) {
  return [checkDisc(puzzle, 272), checkDisc(puzzle, 35651584)];
}
...
export default {
  ...
  example: ['10000'],
  exampleSolutions: ['11010011110011010', '10111110011110111'],
  solutions: ['00100111000101111', '11101110011100110'],
};
